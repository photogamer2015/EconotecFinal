...
- Sesión persistente para todos los roles: cookie de 400 días renovada en cada petición, conservada al cerrar el navegador. Se elimina el plazo absoluto de ocho horas, también para sesiones vigentes de versiones anteriores. El botón Cerrar sesión invalida la sesión del dispositivo. Borrar las cookies, la navegación privada o superar 400 días sin uso puede requerir un nuevo acceso. Las sesiones ya vencidas requieren iniciar sesión de nuevo.
